...
- [x] проверить versionCode/versionName — 7 / 0.4.2
- [x] подписать production release постоянным ключом
- [x] сделать резервную копию signing key
...
- [x] Сайт разработчика
- [x] Иконка 512×512
- [x] Минимум 3 финальных скриншота 9:16 с реального/эмулированного приложения
- [x] Проверить каждый скриншот: ≤3 МБ, одна ориентация
...
## Console
- [x] Добавить приложение в RuStore Console владельцем компании
- [x] Загрузить подписанный APK или AAB
- [x] Проверить автоматически определённые permissions
- [x] Заполнить безопасность данных
- [x] Загрузить иконку и скриншоты
- [x] Отправить на модерацию

## Signing certificate

SHA-256: B6:E3:1E:F5:AE:30:AC:C7:1A:9A:7A:39:6B:D7:E7:18:EB:C7:B6:16:38:FC:A2:5F:E6:8B:2C:70:C3:E5:19:42

Production keystore is stored outside git on the Mac mini at ~/Arvectum/signing/photo-pod-razmer/photo-pod-razmer-release.jks. A verified backup is stored in iCloud Drive under `Arvectum Backups/signing/photo-pod-razmer/2026-09-25/`. Future updates must use the same key.

## RuStore submission status

- Application ID: `2063761491`
- Version ID: `2064846422`
- Version: `0.4.2 (7)`
- Submitted: `2026-09-25`
- Status: `Waiting for moderation`
- Release: `Automatic`, audience `100%`
- Production APK SHA-256: `ec7a26240af82e9b54a0304ee5fd4dcea1fef5daa5b8cdb3f621ae413bd64827`
